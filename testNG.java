...
public class testNG {
   ...
   public void product() throws InterruptedException, IOException {
       ...
       driver.findElement(By.xpath("//a[@href='#' and text()='15']")).click();
       ...
       public void fillDetails() throws IOException, InterruptedException {
           ...
           actions4.moveToElement(mob).click().sendKeys("8009889988").build().perform();

           WebElement altmob = driver.findElement(By.cssSelector("input[placeholder='Alternate No. (Optional)']"));
           Actions actions5 = new Actions(driver);
           actions5.moveToElement(altmob).click().sendKeys("8239782588").build().perform();
           ...
           driver.findElement(By.xpath("//button[@class='apply-coupan-btn revamp-apply-coupan-btn Paragraph-14-S--Semibold' and text()='Apply']")).click();
       ...
       public void makePayment() throws InterruptedException, IOException {
           ...
           FileHandler.copy(screenshot, new File("C:\\Users\\Admin\\Pictures\\Saved Pictures\\pic11.jpg"));
            ...
            driver.findElement(By.xpath("//button[@class='btn-mr u-case order-summ-chkout revamp-payment-button' and text()='proceed\n" +
                    "                                to payment']")).click();
           ...
           WebElement paymentBtn = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[3]/div/section/div[2]/ul/li[4]/div/div[1]/div/div[4]/div/div[6]/div[2]/div/div/form/button")));
           paymentBtn.click();
